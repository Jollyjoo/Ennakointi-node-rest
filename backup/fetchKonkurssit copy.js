...
const interval = 60000; // 1 minute ajoitus uuden tilaston hakuun (millisekuntia)
const jsonfile = path.join(__dirname, 'konkurssit.json'); //Tiedostoon määritelty STAT muotoilu halutuista tiedoista
